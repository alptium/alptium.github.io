...
Овај услов значи да ако је зарада корисника већа од 300.56 и (&&) ако је корисник женског пола, програм ће исписати да је кредит дозвољен или да кредит није дозвољен. С обзиром да наш корисник има зараду од 200.34 еура (мање од услова) и да је женског пола, а услов је да ће кредит бити дозвољен уколико је зарада већа од 300.56 и (&&) да је женског пола, програм ће исписати да кредит није дозвољен -> 'Your loan has been declined / rejected'.
...
**Задатак 5:** Направити банкарски програм који одређује услов да клијент има минимум примања одређене вредности и има преко 18 година.
